...
const JobReceiveJobBoardApplication = () => {
        ...
        <div className="flex  py-[30px] lg:pr-[66px]">
          <div className="bg-white p-[21px] py-[30px] rounded-[20px] border-[1px] border-[#cccccc] w-full">
            <p className="text-[24px] font-[500]">
              Receive Job Boards Applications
            </p>
            ...
            <div className="bg-[#f5f8fe] mt-[17px] lg:w-[411px] rounded-[12px] flex p-[8px] gap-[8px]">
              ...
              <div className="bg-white rounded-[20px] border-[0.5px] border-[#cccccc] p-[12px]">
                <div className="flex gap-[17px] justify-start items-center">
                  <img
                    ...
                    alt=""
                  />
                  <p className="text-[20px] font-[600]">Indeed</p>
                </div>
                <p className="text-[12px] font-[500] text-[#7e7e7e] pt-[16px] pb-[17px]">
...
export default JobReceiveJobBoardApplication;
