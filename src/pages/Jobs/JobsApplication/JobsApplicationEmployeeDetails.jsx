...
const JobsApplicationEmployeeDetails = () => {
          ...
          <div className=" w-full">
            ...
            <div className="px-[27px] bg-white h-screen flex flex-col overflow-y-scroll w-full pt-[20px] pb-[250px] gap-[20px]">
              <div className="flex flex-col rounded-[12px] w-full border-[1px] border-[#d9d9d9]">
                ...
                <div className="flex py-[17px] px-[26px] justify-between lg:gap-[158px]">
                  <div className=" flex flex-col gap-[17px]">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-[500]">Round 3</p>
                    </div>
                  </div>
                  <div className="flex flex-col gap-[17px]">
                    <div>
                ...
                <div className="w-full flex justify-end items-center pt-[46px] p-[20px]">
                  <button className="flex gap-[9px] bg-black rounded-[6px] p-[5px] text-white">
                    <GiNotebook className="text-white" size={"20px"} />
                    Notes
                  </button>
                </div>
              </div>
...
export default JobsApplicationEmployeeDetails;
