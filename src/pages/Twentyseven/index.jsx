...
const TwentysevenPage = () => {
  ...
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-[Poppins] items-center justify-center mx-auto p-[20px] w-full">
        <div className="flex flex-col gap-[26px] items-center justify-center w-full">
          <div className="grid grid-cols-2 lg:flex   gap-5 items-center justify-start ml-0.5 md:ml-[0] w-full">
            ...
            <Button
              className="cursor-pointer font-[500] text-white bg-black leading-[normal] min-w-[111px] ml-5 sm:ml-[0] rounded-lg text-center text-[14px] tracking-[-0.14px]"
              color="black_900"
              size="md"
              variant="fill"
            >
            ...
            <Button
              className="cursor-pointer text-black font-[500] bg-white leading-[normal] min-w-[111px] ml-5 sm:ml-[0] rounded-lg text-center text-[14px] tracking-[-0.14px]"
              color="white_A700"
              size="md"
              variant="fill"
            >
            ...
            <Button
              className="cursor-pointer font-[500] text-black bg-white leading-[normal] min-w-[111px] ml-5 sm:ml-[0] rounded-lg text-center text-[14px] tracking-[-0.14px]"
              color="white_A700"
              size="md"
              variant="fill"
            >
          ...
          <div className="w-full">
            <table className="w-full rounded-[20px] ">
              <thead className="bg-yellow-400 text-[16px] text-center lg:text-left rounded-[20px]">
                <tr>
                  <th className="font-[500] text-left p-2 flex gap-[12px] ">
                    <input type="checkbox" />
                    Name
                  </th>
                  <th className="font-[500] text-left p-2">Application stage</th>
                  <th className="font-[500] text-left p-2">Score Card</th>
                  <th className="font-[500] text-left p-2">Applied Date</th>
                  <th className="font-[500] text-left p-2">Action</th>
                </tr>
              </thead>
      ...
      <HireSidebar side1={side1} openSideBar={openSideBar} />
      {openIndex !== null && (
        <div
