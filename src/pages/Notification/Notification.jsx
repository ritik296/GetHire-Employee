...
import { DeleteApi, GetApi, PostApi } from "Api/Api_Calling";
...
const Notification = () => {
  ...
  const handleDelete = async (id) => {
    setLoading(true);
    try {
      const res = await GetApi(`api/notificationroutes/company/delete/${id}`);
  ...
  return (
    ...
    //           <p className="text-[16px] flex flex-row items-center gap-1 underline text-[#000] text-opacity-[50%] font-[400] font-[Outfit]">
    //              <RiCheckDoubleFill size={20}/>  Mark all as read
    //           </p>
    //         </div>
    //       </div>
      ...
      {selectAllImportant === "Important" ? (
        <div>
          <div className="flex flex-col md:flex-row gap-6 justify-between items-center mt-6">
            ...
            <div className="flex items-center gap-1 text-gray-500 hover:text-gray-700 underline transition-colors duration-300 cursor-pointer">
        ...
        <div className="flex flex-col mt-32 gap-3 justify-center items-center text-center">
          ...
          <button className="rounded-lg mt-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-10 py-4 text-lg font-semibold font-[Outfit] shadow-lg hover:shadow-2xl transition-all duration-300"
           onClick={()=>setSelectAllImportant('Important')}
          >
            Go Back
          </button>
        </div>
      ...
      <div className="flex gap-6 justify-center items-center mt-6 md:mt-0">
        <div className="flex flex-col gap-3 items-center md:items-end">
          <div className="flex gap-3 items-center text-sm font-[Outfit] text-gray-400 opacity-80">
            ...
            <p><CiClock2 size={22} className="text-gray-400"/></p>
        ...
        <p><FaArrowRight className="text-blue-400"/></p>
        {/* <img
