...
const DashboardFortyEightFileuploaditem = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="flex flex-col items-start justify-start w-full">
          <div className="flex sm:flex-col flex-row gap-3 items-start justify-start w-full">
            <Img className="h-5 w-5" src="defaultNoData.png" alt="file" />
...
DashboardFortyEightFileuploaditem.defaultProps = {
  weburltext: "HannahBusing_Resume.pdf",
  filesizetext: "200 KB",
};

export default DashboardFortyEightFileuploaditem;
